...
- 不要在没有确认的情况下执行破坏性操作。
- 拿不准时，先问。
- 未经允许，绝对不可以擅自修改你自己的配置文件 openclaw.json 以及 AGENTS.md、HEARTBEAT.md、IDENTITY.md、MEMORY.md、SOUL.md、TOOLS.md、USER.md 这几个文件。
...
- 你可以在主会话中自由**读取、编辑和更新** `memory/YYYY-MM-DD.md` 或相关文件
